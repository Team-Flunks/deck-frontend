    ...
    return (
      <>
        ...
        >
          ...
          <Modal.Body>
            <p>
              Thanks for playing! You {this.props.didWin ? "did" : "did not"} get a token! <br></br><br></br>Want to play again? Just X out of this screen and start clicking away. Or, return to the home screen to play one of our other games.
            </p>
          </Modal.Body>
          {/* <Modal.Footer>
